    ...
    <div className={`${componentName}_MAIN_CONTAINER flex flex-col gap-8 pt-8`}>
      <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8'>
        <div className='flex flex-col'>
          <h3 className={`${HeaderRegular.className}`}>Chicken Wings</h3>
          <p className='text-left pr-12 text-[#7d7d7d] text-[14px]'>
            8 wings / $12.50 and 12 wings / $18.00
          </p>
        </div>
        <div className='flex flex-col'>
        <h3 className={`${HeaderRegular.className}`}>BUFFALO WINGS</h3>
          <p className='text-left pr-12 text-[#7d7d7d] text-[14px]'>
        ...
        <div className='flex flex-col'>
        <h3 className={`${HeaderRegular.className}`}>BBQ WINGS</h3>
          <p className='text-left pr-12 text-[#7d7d7d] text-[14px]'>
        ...
        <div className='flex flex-col'>
        <h3 className={`${HeaderRegular.className}`}>HONEY GARLIC WINGS</h3>
          <p className='text-left pr-12 text-[#7d7d7d] text-[14px]'>
