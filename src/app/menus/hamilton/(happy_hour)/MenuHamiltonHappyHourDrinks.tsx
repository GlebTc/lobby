...
const MenuHamiltonDrinksZeroProof = () => {
  ...
  return (
    <div className={`${componentName}_MAIN_CONTAINER flex flex-col pt-8`}>
      ...
      >
        <h2
          className={`text-[#c69a50] ${HeaderRegular.className} font-[400] tracking-tight text-[26px] text-left`}
        >
          Wine{' '}
        </h2>
        <table className={`${componentName}_WINE_TABLE w-full text-center mb-8`}>
          <thead>
            <tr>
              <th
      ...
      >
        ...
        >
          {menuHamiltonHappyHourDrinks.cocktail_towers.map(
            (item, index) => {
              return (
                <MenuTitleDescriptionPrice
                  key={index}
