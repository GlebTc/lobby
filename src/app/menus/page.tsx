...
const Location = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/menus/toronto" className='main_button h-full w-full flex flex-col justify-center items-center animate-none text-center gap-4 px-8'>
          <h1>Toronto</h1>
      ...
      >
        <Link href="/menus/hamilton" className='main_button h-full w-full flex flex-col justify-center items-center animate-none text-center gap-4 px-8'>
          <h1>Hamilton</h1>
