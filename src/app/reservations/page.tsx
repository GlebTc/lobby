...
const Reservations = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className='text-lg font-[700] px-2 py-1  text-black border-[1px] border-[var(--main-bg-color)] w-[98dvw] md:w-[70dvw] lg:w-[60dvw] mx-auto h-full flex flex-col gap-4 justify-center items-center rounded-lg relative group shadow-md shadow-[var(--main-text-color)]'>
          <Image
