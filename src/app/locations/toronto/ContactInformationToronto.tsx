  ...
  return (
    ...
    >
      ...
      <a
        ...
        className='uppercase text-base px-4 py-2 bg-[var(--secondary-color)] text-white border-[1px] border-[var(--secondary-color)]  duration-[var(--main-duration)] hover:text-black min-w-[150px] cursor-pointer text-center mb-4 w-[65%]'
      >
        Reserve Now
      </a>
