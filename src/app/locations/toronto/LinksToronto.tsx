...
const LinksToronto = ({ componentName }: { componentName: string }) => {
  return (
    ...
    >
      <Link
        href='/menus/toronto'
        className={`${componentName}_VIEW_MENU_CONTAINER border-t-[1px] border-[var(--secondary-color)] flex p-[10px] gap-8 text-[18px] items-center text-[#54595F]`}
      ...
      <Link
        ...
        className={`${componentName}_BOOK_PRIVATE_EVENTS_CONTAINER border-t-[1px] border-[var(--secondary-color)] flex p-[10px] gap-8 text-[#54595F] text-[18px] items-center`}
      ...
      <Link
        href='/'
        className={`${componentName}_EXPLORE_UPCOMING_EVENTS_CONTAINER border-t-[1px] border-[var(--secondary-color)] flex p-[10px] gap-8 text-[#54595F] text-[18px] items-center`}
        title='Lobby Bar Restaurant | Toronto | Book Private Event'
        aria-label='Lobby Bar Restaurant | Toronto | Book Private Event'
      >
        <CalendarSvg />
