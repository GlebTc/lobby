...
const HoursContainer = ({ componentName, location }: { componentName: string, location: string }) => {
  return (
    ...
    >
      <div className='h-fit p-8 flex flex-col gap-8 justify-center items-center rounded-lg shadow-md shadow-gray-500'>
        ...
        <h3>Join Us for {location}'s favourite BRUNCH every Sunday</h3>
      </div>
    </div>
  );
};
