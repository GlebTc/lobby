  ...
  return (
    ...
    >
      ...
      <a
        ...
        className={`main_button mb-4 min-w-[300px] text-white`}
      >
        Reserve Now
      </a>
      <div className='flex flex-col'>
        <h3 className='font-[500] text-[16px]'>151 James Street South,</h3>
        <h3 className='font-[500] text-[16px]'>Hamilton, ON L8P 2Z5</h3>
        <a
          ...
          href='tel:2893893109'
          className='hover:text-[var(--main-text-color)] w-fit mx-auto duration-[var(--main-duration)] underline text-[16px]'
        >
          1 (289) 389-3109
        </a>
      </div>
